...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	function addCharacter(char:FlxSprite, name:String) {
		switch(name) {
			...
			case 'nikku':
				char.frames = Paths.getSparrowAtlas('dialogue/nikkuPortrait', 'shared'); //oppa gangnam style xddddd kill me
				char.animation.addByPrefix('talkIdle', 'Nikku Portrait Enter instance', 24, true); //Dialogue ended
				char.animation.addByPrefix('talk', 'Nikku Portrait Enter instance', 24, true);
				char.y += 10;
			case 'psychic':
